...
const Footer = () => {
  return (
		<>
			<div className="bg-white p-8 text-md lg:text-lg  font-semibold">
			...
			<section className="bg-[#4733C9] md:bg-transparent text-white pt-10  w-screen 2xl:h-[70vh]  flex items-center Headline justify-center ">
				<img
				...
				<div className="container px-5 md:px-20  lg:px-32 2xl:px-0 2xl:text-3xl ">
					<div className="flex flex-col text-xs md:text-base md:flex-row font-medium justify-between md:items-start mb-10 pb-5">
						{/* <div className="flex items-center md:items-start mx-4 md:flex-nowrap space-y-2 md:space-y-0 flex-wrap  justify-between 2xl:text-3xl">
