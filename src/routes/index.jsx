...
function Index() {
  ...
  return (
    <main className="w-screen Headline">
      ...
      {/* Second Section */}
      <section className="w-screen my-8 px-4" id="Services md:px-40">
        <div className="flex flex-col mb-5 2xl:mb-8 space-y-5">
          <h1 className="flex justify-center items-center 2xl:text-4xl text-xl text-[#624DE7] font-semibold my-2">
            Services
          </h1>
          <h5 className="flex justify-center items-center text-center font-extrabold 2xl:text-6xl text-2xl md:text-4xl px-5 ">
        ...
        <div className="cards flex flex-col sm:flex-row flex-wrap gap-5 items-center justify-center">
          {services.map((el, idx) => (
            <div
              key={idx}
              className="w-full sm:w-[48%] xl:w-[22%] 2xl:h-[30vh] h-[45vh] flex flex-col items-center justify-between border-t-4 border-[#624DE7] shadow-md shadow-gray-200 p-5 md:p-10 rounded-md rounded-br-[50px] mb-5"
            >
              <div className="flex flex-col">
                <h1 className="text-3xl 2xl:text-5xl font-bold text-[#624DE7] ">
                  {el.cardTitle}
                </h1>
                <p className="text-lg 2xl:text-2xl mt-3 md:text-base text-gray-700 font-normal">
                  {el.cardDescription}
                </p>
              </div>
      ...
      {/* Why Us Section */}
      <section className="w-screen px-5 md:flex mb-14 md:px-40 2xl:px-56 2xl:mt-20">
        <div className="w-full xl:w-[45vw]  xl:px-16">
          <div className="flex flex-col 2xl:space-y-7 mb-5 py-5">
            <h1 className="flex justify-center items-center 2xl:text-4xl text-xl text-[#624DE7] font-semibold mb-2">
              Why Us
            </h1>
            <h5 className="flex justify-center items-center text-center font-bold text-2xl 2xl:text-6xl md:text-3xl mb-2">
              We have over 9+ Years in the Tech Industry
            </h5>
            <p className="text-lg md:text-md 2xl:text-3xl text-gray-700 px-3 md:px-7 font-normal">
          ...
          <div className="px-5 md:px-12 mt-3 2xl:space-y-7 pb-5">
            {dropdown.map((el, idx) => (
              <div key={idx} className="mb-2 ">
                <h1
                  onClick={() => handleToggle(idx)}
                  className="text-lg 2xl:text-3xl font-bold cursor-pointer flex items-center "
                >
                  <FontAwesomeIcon
                    icon={faXmark}
                ...
                {activeIndex === idx && (
                  <div className="p-2 description rounded-md 2xl:text-3xl">
                    {el.description}
                  </div>
                )}
              </div>
      ...
      <section id="Form" className=" bg-[#4733C9]  w-screen text-black pt-12 ">
